...
class _VoiceChatScreenState extends State<VoiceChatScreen> {
  ...
  String _transcribedText = 'Toque el micrófono para comenzar';
  ...
  void _listen() async {
    if (!_isListening) {
      ...
      setState(() {
        _isListening = false;
        _transcribedText = 'Toque el micrófono para comenzar';
      });
      _speechToText.stop();
    }
  }
  ...
  void _toggleLanguage() {
    setState(() {
      _isArabic = !_isArabic;
      _selectedLanguage = _isArabic ? 'ar-EG' : 'es-ES';
      _transcribedText = 'Toque el micrófono para comenzar';
    });
    _initTts();
  }
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    tooltip: _isSpeaking ? 'Detener voz' : 'Escuchar respuesta',
                  ),
                ],
              ),
              const SizedBox(height: 8),
