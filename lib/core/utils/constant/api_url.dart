...
class EnvManager {
  ...
  static String generativeModelApiKey = dotenv.env['GENERATIVE_MODEL_API_KEY'] ?? "AIzaSyA83hVEckjEhf3KWkxMWyvFQue2VsQR8k0";
  static String generativeModelVersion = "gemini-2.5-flash";
